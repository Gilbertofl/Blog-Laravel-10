...
<label class="uppercase text-white text-sm">Titulo</label>
...
<label class="uppercase text-white text-sm">Slug</label>
...
<label class="uppercase text-white text-sm">Contenido</label>
...
<div class="flex justify-between items-center">
    ...
    <input type="submit" value="Enviar" class="bg-white text-gray-800 rounded px-4 py-2">
</div>